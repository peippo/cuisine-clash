  ...
  return (
    <button
      ...
      className={classNames(
        "relative mt-6 self-center rounded-lg border-t-2 border-l-2 border-indigo-600 bg-gradient-to-b from-indigo-700 to-indigo-900 py-2 px-8 pb-3 text-xl text-cyan-100",
