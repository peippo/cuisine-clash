...
const RedrawButton = () => {
  ...
  return (
    ...
    >
      <span
        className={classNames(
          "absolute -right-2 -top-3 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-b from-purple-500 via-purple-800 to-fuchsia-900 text-3xl text-white drop-shadow-md",
      ...
      <span className="flex pt-1 pb-2 pr-20 pl-5 text-lg">
        {hasRedraws
